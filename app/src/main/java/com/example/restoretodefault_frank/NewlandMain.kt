...
class NewlandMain : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mNewlandList.add(NlsSetting("1D 2열 바코드 설정","1D Twin(2열)바코드 활성화 / 비활성화 / 모두 사용", listOf(R.drawable.nls00enter, R.drawable.nls001dsingleonly, R.drawable.nls001dtwinonly, R.drawable.nls001dsingletwin, R.drawable.nls00exit)))
        ...
        mNewlandList.add(NlsSetting("[무선] 리셋 스캐너, 크레들","Reset Scanner & Cradle", listOf(R.drawable.nls00enter, R.drawable.nls00btresetscanner,R.drawable.nls00btresetcradle, R.drawable.nls00exit)))
